...
title = customtkinter.CTkLabel(app, text=" Feed me your desired string to encode into morse code  ", font=("Arial", 28), text_color="#14FFEC")
...
encode = customtkinter.CTkButton(app, text=" Encode ", font=("Arial", 20), text_color="#323232", command=morse_encode, fg_color="#0D7377", border_color="#14FFEC", border_width=2, hover_color="#14FFEC", corner_radius=20)
